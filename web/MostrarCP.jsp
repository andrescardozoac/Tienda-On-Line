    ...
    <body>
        <form id="frmMostrarCabeceraCP">
            <table id="tablaMostrarCabeceraCP">
                <tr>
                    <th>
                        <h1> Clasificacion Pelicula Habilitados </h1>
                    </th>
                </tr>
                <tr>
                    <td>
        ...
        <form id="frmMostrarCuerpoCP">
            <table id="tablaMostrarCuerpoCP">
                ...
                <tr>
                    ...
                    <td class="Opcion">
                        <input type="button" name="btnEliminar" value="Inhabilitar" id="btnEliminar" class="button" onclick="location.href='Servlet_ClasificacionP?codigoCP=<%=CP.getCodigoCP() %>&&accion=eliminar'">
                    </td>
                </tr>
