    ...
    <body>
        ...
        <form id="frmMostrarCuerpoProdEliminados">
            <table id="tablaMostrarCuerpoProdEliminados">
                ...
                <% 
                    ArrayList<Pelicula> lista = Pelicula_DB.obtenerPeliculasInhabilitadas();
                ...
                <tr>
                    ...
                    <td class="Opcion">
                        <input type="button" name="btnRecuperar" id="btnRecuperar" class="button" value="Habilitar" onclick="location.href='Servlet_Pelicula?codigoP=<%=P.getCodigoP() %>&&accion=recuperar'">
                    </td>
                </tr>
