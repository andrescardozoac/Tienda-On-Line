...
<html>
    ...
    <body onload="cargar()">
        <form name="frm" action="Servlet_Pelicula" method="post" id="frmModificarProd">
            <table id="tablaModificarProd">
                ...
                <tr>
                    ...
                    <td>
                        <dd> <input type="text" name="txtNombreCP" id="txtNombreCP" value="<%=p.getClasificacionPelicula()%>" size="30" maxlength="30"> </dd>
                    </td>
                </tr>
                <tr>
                    <td class="primeraColumna">
                    ...
                    <td>
                        <dd> <input type="text" name="txtNombreMP" id="txtNombreMP" value="<%=p.getGeneroPelicula()%>" size="30" maxlength="30"> </dd>
                    </td>
                </tr>
                 <tr>
                    <td class="primeraColumna">
                    ...
                    <td>
                        <dd> <input type="text" name="txtTituloP" id="txtTituloP" value="<%=p.getTitulo() %>" size="30" maxlength="30"> </dd>
                    </td>
                </tr>
                <tr>
                    <td class="primeraColumna">
