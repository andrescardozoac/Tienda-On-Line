...
<html>
    ...
    <%
        // Obtenemos las variables del jsp MostrarGP (Dentro del boton modificar)
        String codigo = request.getParameter("codigoMP");
        String nombre = request.getParameter("nombreMP");
    %>
    
    <body onload="cargar()">
        <form action="Servlet_GeneroP" method="post" name="frm" id="frmModificarMP">
            <table id="tablaModificarMP">
                <tr>
                    <th colspan="2">
                        <h1> Modificar Genero Pelicula </h1>
                    </th>
                </tr>
                <tr>
                    <td colspan="2">
