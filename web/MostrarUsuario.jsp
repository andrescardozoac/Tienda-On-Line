        ...
        <form id="frmMostrarCuerpoUsuario">
            <table id="tablaMostrarCuerpoUsuario">
                ...
                <tr>
                    ...
                    <td class="Opcion">
                        <input type="button" name="btnEliminar" value="Inhabilitar" id="btnEliminar" class="button" onclick="location.href='Servlet_Usuario?codigoU=<%=usu.getCodigoUsuario()%>&&accion=eliminar'">
                    </td>
                </tr>
